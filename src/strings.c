...
const u8 gText_NumericalModeNational[] = _("MODO NUMÉRICO: NATIONAL");
...
const u8 gText_MiracleSeed_1000Coins[] = _("SEMILLA MILAGRO{CLEAR_TO 0x50}{SMALL}1,000 MON.");
const u8 gText_Charcoal_1000Coins[] = _("CARBÓN{CLEAR_TO 0x50}{SMALL}1,000 MON.");
const u8 gText_MysticWater_1000Coins[] = _("AGUA MÍSTICA{CLEAR_TO 0x50}{SMALL}1,000 MON.");
const u8 gText_YellowFlute_1600Coins[] = _("FLAUTA AMARILLA{CLEAR_TO 0x50}{SMALL}1,600 MON.");
const u8 gText_SmokeBall_800Coins[] = _("BOLA DE HUMO{CLEAR_TO 0x5A}{SMALL}800 MON.");
