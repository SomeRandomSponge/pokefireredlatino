...
const u8 gSaveStatName_Player[] = _("JUGADOR{AM}");
...
const u8 gUnknown_841623D[] = _("SÍ\nNO");
...
const u8 gStartMenuText_Bag[] = _("MOCHILA");
const u8 gUnknown_8416289[] = _("ポケナビ");
const u8 gStartMenuText_Player[] = _("{PLAYER}");
const u8 gStartMenuText_Save[] = _("GUARDAR");
const u8 gStartMenuText_Option[] = _("OPCIONES");
const u8 gStartMenuText_Exit[] = _("SALIR");
const u8 gStartMenuText_Retire[] = _("SALIR");
const u8 gUnknown_84162A9[] = _("{STR_VAR_1}/{STR_VAR_2}\nBOLAS  {STR_VAR_3}");
const u8 gText_TimesStrVar1[] = _("×{STR_VAR_1}");
const u8 gUnknown_84162BD[] = _("BAYA");
...
const u8 gUnknown_8416451[] = _("No puedes bajarte de la BICI aquí.{PAUSE_UNTIL_PRESS}");
...
const u8 gMenuText_Confirm[] = _("BIEN");
...
const u8 gUnknown_8417693[] = _("PS");
...
const u8 gText_Bicycle_1000000[] = _("BICICLETA{CLEAR_TO 0x49}{FONT_0}¥1,000,000");
const u8 gText_NoThanks[] = _("NO GRACIAS");
const u8 gText_Abra_180Coins[] = _("ABRA{CLEAR_TO 0x55}{FONT_0} 180 MONEDAS");
const u8 gText_Clefairy_500Coins[] = _("CLEFAIRY{CLEAR_TO 0x55}{FONT_0} 500 MONEDAS");
const u8 gText_Dratini_2800Coins[] = _("DRATINI{CLEAR_TO 0x4B}{FONT_0} 2,800 MONEDAS");
const u8 gText_Scyther_5500Coins[] = _("SCYTHER{CLEAR_TO 0x4B}{FONT_0} 5,500 MONEDAS");
const u8 gText_Porygon_9999Coins[] = _("PORYGON{CLEAR_TO 0x4B}{FONT_0} 9,999 MONEDAS");
const u8 gText_Abra_120Coins[] = _("ABRA{CLEAR_TO 0x55}{FONT_0} 120 MONEDAS");
const u8 gText_Clefairy_750Coins[] = _("CLEFAIRY{CLEAR_TO 0x55}{FONT_0} 750 MONEDAS");
const u8 gText_Pinsir_2500Coins[] = _("PINSIR{CLEAR_TO 0x4B}{FONT_0} 2,500 MONEDAS");
const u8 gText_Dratini_4600Coins[] = _("DRATINI{CLEAR_TO 0x4B}{FONT_0} 4,600 MONEDAS");
const u8 gText_Porygon_6500Coins[] = _("PORYGON{CLEAR_TO 0x4B}{FONT_0} 6,500 MONEDAS");
...
const u8 gText_MiracleSeed_1000Coins[] = _("SEMILLA MILAGRO{CLEAR_TO 0x50}{FONT_0}1,000 MON.");
const u8 gText_Charcoal_1000Coins[] = _("CARBÓN{CLEAR_TO 0x50}{FONT_0}1,000 MON.");
const u8 gText_MysticWater_1000Coins[] = _("AGUA MÍSTICA{CLEAR_TO 0x50}{FONT_0}1,000 MON.");
const u8 gText_YellowFlute_1600Coins[] = _("FLAUTA AMARILLA{CLEAR_TO 0x50}{FONT_0}1,600 MON.");
const u8 gText_SmokeBall_800Coins[] = _("BOLA DE HUMO{CLEAR_TO 0x5A}{FONT_0}800 MON.");
...
const u8 gUnknown_841B2A9[] = _("{FONT_2}PS {FONT_0}MÁX.");
const u8 gUnknown_841B2B7[] = _("ATAQUE");
const u8 gUnknown_841B2BE[] = _("DEFENSA");
const u8 gUnknown_841B2C6[] = _("VELOCIDAD");
const u8 gUnknown_841B2CC[] = _("ATQ. ESP.");
const u8 gUnknown_841B2D4[] = _("DEF. ESP.");
const u8 gUnknown_841B2DC[] = _("{FONT_0}{PLUS}{FONT_2}");
const u8 gUnknown_841B2E5[] = _("{FONT_0}-{FONT_2}");
const u8 gUnknown_841B2ED[] = _("1, ");
const u8 gUnknown_841B2F1[] = _("2, Y ‥ ‥ ‥ ");
...
const u8 gUnknown_841B68F[] = _("NACIONAL");
