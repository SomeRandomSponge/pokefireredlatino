...
const u8 gExpandedPlaceholder_O[] = _("o");
const u8 gExpandedPlaceholder_A[] = _("a");
const u8 gExpandedPlaceholder_E[] = _("e");
const u8 gExpandedPlaceholder_EL[] = _("el");
...
const u8 gExpandedPlaceholder_RRA[] = _("gorra");
const u8 gExpandedPlaceholder_SOM[] = _("sombrero");
...
const u8 gText_WirelessNotConnected[] = _("El Adaptador Inalámbrico no está\nconectado.");
const u8 gText_MysteryGiftCantUse[] = _("El REGALO MISTERIOSO no se puede\lusar mientras el Adaptador\nInalámbrico está conectado.");
...
const u8 gText_SaveFileCorrupted[] = _("El archivo de guardado está\ncorrupto.\pEl archivo de guardado previo\nserá cargado.");
const u8 gText_SaveFileHasBeenDeleted[] = _("El archivo de guardado fue\nborrado...");
const u8 gText_1MSubCircuitBoardNotInstalled[] = _("La placa de sub-circuitos M1\nno está instalada.");
...
const u8 gText_MainMenuTime[] = _("TIEMPO");
...
const u8 gText_PokedexTableOfContents[] = _("POKéDEX   TABLA DE CONTENIDOS");
const u8 gText_PickOK[] = _("{DPAD_UPDOWN}SEL. {A_BUTTON}BIEN");
...
const u8 gText_PokemonHabitats[] = _("{COLOR DYNAMIC_COLOR6}{SHADOW DYNAMIC_COLOR5}POKéMON SEGÚN SUS HÁBITATS");
...
const u8 gText_DexCategory_CavePkmn[] = _("POKéMON de cuevas");
const u8 gText_DexCategory_MountainPkmn[] = _("POKéMON de montaña");
const u8 gText_DexCategory_RoughTerrainPkmn[] = _("POKéMON de terreno duro");
const u8 gText_DexCategory_UrbanPkmn[] = _("POKéMON urbanos");
const u8 gText_DexCategory_RarePkmn[] = _("POKéMON raros");
const u8 gText_Search[] = _("{COLOR DYNAMIC_COLOR6}{SHADOW DYNAMIC_COLOR5}BÚSQUEDA");
const u8 gText_NumericalMode[] = _("MODO NUMÉRICO");
const u8 gText_AToZMode[] = _("MODO DE A-Z");
const u8 gText_PokedexOther[] = _("{COLOR DYNAMIC_COLOR6}{SHADOW DYNAMIC_COLOR5}OTROS");
const u8 gTextJP_HowToUsePokedex[] = _("ずかんの つかいかた");
const u8 gText_ClosePokedex[] = _("CERRAR LA POKéDEX");
const u8 gText_TypeMode[] = _("MODO POR TIPOS");
const u8 gText_LightestMode[] = _("MODO POR PESO");
const u8 gText_SmallestMode[] = _("MODO POR TAMAÑOS");
const u8 gText_PokemonList[] = _("{COLOR DYNAMIC_COLOR6}{SHADOW DYNAMIC_COLOR5}LISTA DE POKéMON");
const u8 gText_NumericalModeKanto[] = _("MODO NUMÉRICO: KANTO");
const u8 gText_NumericalModeNational[] = _("MODO NUMÉRICO: NACIONAL");
const u8 gText_PokemonListNoColor[] = _("LISTA DE POKéMON");
const u8 gText_SearchNoColor[] = _("BÚSQUEDA");
const u8 gText_PickOKExit[] = _("{DPAD_UPDOWN}SEL. {A_BUTTON}BIEN {B_BUTTON}ATRÁS");
...
const u8 gText_CancelPreviousData[] = _("{A_BUTTON}ATRÁS {B_BUTTON}DATOS ANT.");
...
ALIGNED(4) const u8 gText_WelcomeToHOF[] = _("¡Bienvenido al SALÓN de la FAMA!");
ALIGNED(4) const u8 gText_WelcomeToHOF_Female[] = _("¡Bienvenida al SALÓN de la FAMA!");
...
const u8 gText_HOFNumber[] = _("SALÓN de la FAMA Núm. {STR_VAR_1}");
const u8 gText_LeagueChamp[] = _("¡CAMPEÓN de la LIGA!\n¡FELICIDADES!");
const u8 gText_LeagueChamp_Female[] = _("¡CAMPEONA de la LIGA!\n¡FELICIDADES!");
ALIGNED(4) const u8 gText_Number[] = _("Núm. ");
ALIGNED(4) const u8 gText_Level[] = _("Nivel. ");
...
const u8 gText_SaveError_PleaseExchangeBackupMemory[] = _("Error de guardado.\pPor favor cambia la memoria de\nrespaldo.");
const u8 gSaveStatName_Player[] = _("JUGADOR");
const u8 gSaveStatName_Player_Female[] = _("JUGADORA");
const u8 gSaveStatName_Badges[] = _("MEDALLAS");
const u8 gSaveStatName_Pokedex[] = _("POKéDEX");
const u8 gSaveStatName_Time[] = _("TIEMPO");
...
const u8 gFameCheckerText_Cancel[] = _("ATRÁS");
...
const u8 gOtherText_Check[] = _("REVISAR");
const u8 gText_PokeSum_Item_None[] = _("NINGUNO");
...
const u8 gText_GoBackToThePreviousMenu[] = _("Volver al\nmenú anterior.");
...
const u8 gText_MenuRetire[] = _("SALIR");
...
const u8 gText_PokeBalls2[] = _("POKéBOLAS");
const u8 gText_KeyItems2[] = _("OBJ. CLAVE");
const u8 gText_DepositItem[] = _("DEPOSITAR OBJETOS");
...
const u8 gText_ItemCantBeHeld[] = _("No puede llevar {STR_VAR_1}.");
...
const u8 gText_ThrewAwayStrVar2StrVar1s[] = _("Tiraste {STR_VAR_2}\n{STR_VAR_1}.");
const u8 gText_ThrowAwayStrVar2OfThisItemQM[] = _("¿Vas a tirar {STR_VAR_2} \nde este objeto?");
const u8 gText_OakForbidsUseOfItemHere[] = _("OAK: ¡{PLAYER}!\n¡Este no es el momento para esto!{PAUSE_UNTIL_PRESS}");
const u8 gText_CantDismountBike[] = _("No puedes bajarte de la BICI aquí.{PAUSE_UNTIL_PRESS}");
...
const u8 gText_NopeTheresNoResponse[] = _("‥ ‥ ‥ ‥¡Nop!\nNo hay respuesta.{PAUSE_UNTIL_PRESS}");
...
const u8 gText_TMCase[] = _("ESTUCHE MTS");
...
const u8 gText_ShopQuit[] = _("¡ADIÓS!");
const u8 gText_InBagVar1[] = _("EN LA MOCHILA:{FONT_SMALL} {STR_VAR_1}");
...
const u8 gText_AnythingElseICanHelp[] = _("¿Hay algo más que pueda hacer?");
...
const u8 gText_OhNoICantBuyThat[] = _("¿{STR_VAR_1}? Oh, no.\nNo puedo comprar esto.{PAUSE_UNTIL_PRESS}");
const u8 gText_HowManyWouldYouLikeToSell[] = _("{STR_VAR_1}?\nHow many would you like to sell?");
const u8 gText_ICanPayThisMuch_WouldThatBeOkay[] = _("Te puedo pagar ¥{STR_VAR_3}.\n¿Eso está bien?");
...
const u8 gText_PartyMenu_OK[] = _("BIEN");
...
const u8 gText_ChoosePokemon[] = _("Elige a un POKéMON.");
...
const u8 gText_DoWhatWithItem[] = _("¿Hacer qué con un objeto?");
const u8 gText_NoPokemonForBattle[] = _("No battling this way!");
const u8 gText_ChoosePokemon2[] = _("Elige a un POKéMON.");
...
const u8 gText_OakImportantToGetToKnowPokemonThroughly[] = _("OAK: Es importante que conozcas\nmuy bien a tus POKéMON.\p");
const u8 gText_OakThisIsListOfPokemon[] = _("Ésta es una lista de tus POKéMON,\n{PLAYER}.\pÁbrela para ver las habilidades\ny movimientos de tus POKéMON.\pTambién puedes eligir POKéMON aquí\nsi quieres usar un objeto en uno.{PAUSE_UNTIL_PRESS}");
const u8 gText_CutATreeOrGrass[] = _("Corta un árbol o hierba.");
const u8 gText_FlyToAKnownTown[] = _("Ve a un lugar conocido.");
const u8 gText_TravelOnWater[] = _("Viaja por el agua.");
const u8 gText_MoveHeavyBoulders[] = _("Mueve piedras pesadas.");
const u8 gText_LightUpDarkness[] = _("Ilumina zonas oscuras.");
const u8 gText_ShatterACrackedRock[] = _("Rompe rocas agrietadas.");
const u8 gText_ClimbAWaterfall[] = _("Escala una cascada.");
const u8 gText_DiveUnderwater[] = _("すいちゅうに もぐる");
const u8 gText_EscapeFromHere[] = _("Escapa de aquí.");
const u8 gText_LureWildPokemon[] = _("Atrae POKéMON salvajes.");
const u8 gText_ShareHp[] = _("Comparte PS.");
const u8 gText_ReturnToAHealingSpot[] = _("Ir a curar tu equipo.");
const u8 gText_EscapeFromHereAndReturnTo[] = _("¿Quieres escapar de aquí y volver\na {STR_VAR_1}?");
const u8 gText_ReturnToHealingSpot[] = _("¿Quieres volver al último lugar de\ncuración usado en {STR_VAR_1}?");
...
const u8 gText_ItemEffect_Speed[] = _("VELOCIDAD");
...
const u8 gText_LtSurge[] = _("TENIENTE SURGE");
...
const u8 gText_SodaPop_300[] = _("SODA{CLEAR_TO 0x57}{FONT_SMALL}¥300");
const u8 gText_Lemonade_350[] = _("LIMONADA{CLEAR_TO 0x57}{FONT_SMALL}¥350");
const u8 gText_50Coins_1000[] = _("{FONT_SMALL} 50 MON.{CLEAR_TO 0x45}¥1,000");
const u8 gText_500Coins_10000[] = _("{FONT_SMALL}500 MON.{CLEAR_TO 0x40}¥10,000");
...
const u8 gText_Tm13_4000Coins[] = _("MT13{CLEAR_TO 0x48}{FONT_SMALL}4,000 MON.");
const u8 gText_Tm23_3500Coins[] = _("MT23{CLEAR_TO 0x48}{FONT_SMALL}3,500 MON.");
const u8 gText_Tm24_4000Coins[] = _("MT24{CLEAR_TO 0x48}{FONT_SMALL}4,000 MON.");
const u8 gText_Tm30_4500Coins[] = _("MT30{CLEAR_TO 0x48}{FONT_SMALL}4,500 MON.");
const u8 gText_Tm35_4000Coins[] = _("MT35{CLEAR_TO 0x48}{FONT_SMALL}4,000 MON.");
...
const u8 gText_Cool_2[] = _("CARISMA");
const u8 gText_Beauty_2[] = _("BELLEZA");
const u8 gText_Cute_2[] = _("DULZURA");
const u8 gText_Smart_2[] = _("INGENIO");
const u8 gText_Tough_2[] = _("DUREZA");
const u8 gText_Items[] = _("OBJETOS");
const u8 gText_KeyItems[] = _("OBJ. CLAVE");
const u8 gText_PokeBalls[] = _("POKéBOLAS");
const u8 gText_TMsAndHMs[] = _("MTs & MOs");
const u8 gText_Berries[] = _("BAYAS");
const u8 gText_Boulderbadge[] = _("MEDALLAROCA");
const u8 gText_Cascadebadge[] = _("MEDALLACASCADA");
const u8 gText_Thunderbadge[] = _("MEDALLATRUENO");
const u8 gText_Rainbowbadge[] = _("MEDALLAARCOÍRIS");
const u8 gText_Soulbadge[] = _("MEDALLAALMA");
const u8 gText_Marshbadge[] = _("MEDALLAPANTANO");
const u8 gText_Volcanobadge[] = _("MEDALLAVOLCÁN");
const u8 gText_Earthbadge[] = _("MEDALLATIERRA");
...
const u8 gText_SodaPop[] = _("SODA");
const u8 gText_Lemonade[] = _("LIMONADA");
const u8 gText_Coins_2[] = _("MONEDAS");
const u8 gText_Bicycle_Price[] = _("BICICLETA{CLEAR_TO 0x49}{FONT_SMALL}¥1,000,000");
const u8 gText_NoThanks[] = _("NO GRACIAS");
const u8 gText_Abra_180Coins[] = _("ABRA{CLEAR_TO 0x55}{FONT_SMALL} 180 MON.");
const u8 gText_Clefairy_500Coins[] = _("CLEFAIRY{CLEAR_TO 0x55}{FONT_SMALL} 500 MON.");
const u8 gText_Dratini_2800Coins[] = _("DRATINI{CLEAR_TO 0x4B}{FONT_SMALL} 2,800 MON.");
const u8 gText_Scyther_5500Coins[] = _("SCYTHER{CLEAR_TO 0x4B}{FONT_SMALL} 5,500 MON.");
const u8 gText_Porygon_9999Coins[] = _("PORYGON{CLEAR_TO 0x4B}{FONT_SMALL} 9,999 MON.");
const u8 gText_Abra_120Coins[] = _("ABRA{CLEAR_TO 0x55}{FONT_SMALL} 120 MON.");
const u8 gText_Clefairy_750Coins[] = _("CLEFAIRY{CLEAR_TO 0x55}{FONT_SMALL} 750 MON.");
const u8 gText_Pinsir_2500Coins[] = _("PINSIR{CLEAR_TO 0x4B}{FONT_SMALL} 2,500 MON.");
const u8 gText_Dratini_4600Coins[] = _("DRATINI{CLEAR_TO 0x4B}{FONT_SMALL} 4,600 MON.");
const u8 gText_Porygon_6500Coins[] = _("PORYGON{CLEAR_TO 0x4B}{FONT_SMALL} 6,500 MON.");
const u8 gText_NoThanks_2[] = _("NO GRACIAS");
const u8 gText_HelixFossil[] = _("FÓSIL HÉLIX");
...
const u8 gText_KeyItemsPocket[] = _("BOLSILLO OBJ. CLAVE");
const u8 gText_PokeBallsPocket[] = _("BOLSILLO POKéBOLAS");
const u8 gText_TmCase[] = _("ESTUCHE DE MTs");
const u8 gText_BerryPouch_2[] = _("SACO DE BAYAS");
const u8 gText_Other[] = _("OTROS");
...
const u8 gText_2Tinymushrooms[] = _("2 HONGOS PEQUEÑOS");
const u8 gText_1BigMushroom[] = _("1 HONGO GRANDE");
const u8 gText_SeviiIslands[] = _("ISLAS SETE");
const u8 gText_NavelRock[] = _("ROCA OMBLIGO");
const u8 gText_BirthIsland[] = _("ISLA ORIGEN");
const u8 gText_MiracleSeed_1000Coins[] = _("SEMILLA MIL.{CLEAR_TO 0x50}{FONT_SMALL}1,000 MON.");
const u8 gText_Charcoal_1000Coins[] = _("CARBÓN{CLEAR_TO 0x50}{FONT_SMALL}1,000 MON.");
const u8 gText_MysticWater_1000Coins[] = _("AGUA MÍSTICA{CLEAR_TO 0x50}{FONT_SMALL}1,000 MON.");
const u8 gText_YellowFlute_1600Coins[] = _("FLAUTA AM.{CLEAR_TO 0x50}{FONT_SMALL}1,600 MON.");
const u8 gText_SmokeBall_800Coins[] = _("BOLA DE HUMO{CLEAR_TO 0x5A}{FONT_SMALL}800 MON.");
...
const u8 gText_VolcanoBadge[] = _("MEDALLAVOLCÁN");
const u8 gText_EarthBadge[] = _("MEDALLATIERRA");
const u8 gText_1F[] = _("P1");
const u8 gText_2F[] = _("P2");
const u8 gText_3F[] = _("P3");
const u8 gText_4F[] = _("P4");
const u8 gText_5F[] = _("P5");
const u8 gText_6F[] = _("P6");
const u8 gText_7F[] = _("P7");
const u8 gText_8F[] = _("P8");
const u8 gText_9F[] = _("P9");
const u8 gText_10F[] = _("P10");
const u8 gText_11F[] = _("P11");
const u8 gText_B1F[] = _("SP1");
const u8 gText_B2F[] = _("SP2");
const u8 gText_B3F[] = _("SP3");
const u8 gText_B4F[] = _("SP4");
const u8 gText_Rooftop[] = _("TEJADO");
const u8 gText_NowOn[] = _("Ahora en:");
const u8 gText_LinkedGamePlay[] = _("PARTIDA CONECTADA");
...
const u8 gText_YourName[] = _("¿TÚ NOMBRE?");
const u8 gText_BoxName[] = _("¿NOMBRE DE CAJA?");
const u8 gText_PkmnsNickname[] = _("¿Apodo de ");
const u8 gText_RivalsName[] = _("¿NOMBRE DEL RIVAL?");
const u8 gText_PkmnsQuestion[] = _("?");
const u8 gText_MoveOkBack[] = _("{DPAD_ANY}MOVER {A_BUTTON}BIEN {B_BUTTON}ATRÁS");
const u8 gText_AlphabetUpperLower[] = _("");
const u8 gText_RegionMap_Space[] = _(" ");
const u8 gText_RegionMap_AButtonGuide[] = _("{A_BUTTON}GUIA");
const u8 gText_RegionMap_AButtonCancel[] = _("{A_BUTTON}ATRÁS");
const u8 gText_RegionMap_AButtonCancel2[] = _("{A_BUTTON}ATRÁS");
const u8 gText_RegionMap_AButtonSwitch[] = _("{A_BUTTON}CAMBIAR");
const u8 gText_RegionMap_AButtonOK[] = _("{A_BUTTON}BIEN");
...
const u8 gText_PokeSum_Met[] = _("Naturaleza {DYNAMIC 0x00}.\nMet in {DYNAMIC 0x02} at {LV_2} {DYNAMIC 0x01}.");
const u8 gText_PokeSum_Met_BoldGentleGrammar[] = _("Naturaleza {DYNAMIC 0x00}.\nMet in {DYNAMIC 0x02} at {LV_2} {DYNAMIC 0x01}.");
...
const u8 gText_PokeSum_FatefulEncounterHatched[] = _("Naturaleza {DYNAMIC 0x00}. Met in a fateful\nencounter (hatched: {DYNAMIC 0x02}\nat {LV_2} {DYNAMIC 0x01}).");
const u8 gText_PokeSum_FatefulEncounterHatched_BoldGentleGrammar[] = _("Naturaleza {DYNAMIC 0x00}. Met in a fateful\nencounter (hatched: {DYNAMIC 0x02}\nat {LV_2} {DYNAMIC 0x01}).");
const u8 gText_PokeSum_ApparentlyFatefulEncounterHatched[] = _("Naturaleza {DYNAMIC 0x00}. Apparently met in\na fateful encounter (hatched:\n{DYNAMIC 0x02} at {LV_2} {DYNAMIC 0x01}).");
const u8 gText_PokeSum_ApparentlyFatefulEncounterHatched_BoldGentleGrammar[] = _("Naturaleza {DYNAMIC 0x00}. Apparently met in\na fateful encounter (hatched:\n{DYNAMIC 0x02} at {LV_2} {DYNAMIC 0x01}).");
...
const u8 gText_PokeSum_NoData[] = _("Sin datos.");
const u8 gText_PokeSum_ExpPoints[] = _("PUNTOS DE EXP.");
const u8 gText_PokeSum_NextLv[] = _("SIGUIENTE NIVEL");
const u8 gText_PokeSum_Controls_PageCancel[] = _("{DPAD_RIGHT}PÁG. {A_BUTTON}SALIR");
const u8 gText_PokeSum_Controls_Cancel[] = _("{A_BUTTON}ATRÁS");
...
const u8 gText_BattleStyleSet[] = _("FIJO");
...
const u8 gText_LevelUp_Speed[] = _("VELOCIDAD");
...
const u8 gText_Player_Female[] = _("JUGADORA");
...
const u8 gText_Register[] = _("ASIGNAR");
...
const u8 gString_OutOfCoins[] = _("Te quedaste sin MONEDAS.\n¡Fin del juego!");
const u8 gString_QuitPlaying[] = _("¿Dejar de jugar?");
const u8 gString_SlotMachineControls[] = _("{DPAD_LEFTRIGHT}COMBOS {DPAD_DOWN}APOSTAR {A_BUTTON}PARAR {B_BUTTON}SALIR");
...
ALIGNED(4) const u8 gString_PokemonFireRed_Staff[] = _("Pokémon Edición RojoFuego\nStaff");
ALIGNED(4) const u8 gString_PokemonLeafGreen_Staff[] = _("Pokémon Edición VerdeHoja\nStaff");
ALIGNED(4) const u8 gCreditsString_Director[] = _("\n\nDirector\n\n\n\n");
ALIGNED(4) const u8 gCreditsString_Junichi_Masuda[] = _("\n\n\nJunichi Masuda\n\n\n");
ALIGNED(4) const u8 gCreditsString_Art_Director_Battle_Director[] = _("\nDirector de arte\n\nDirector de batallas\n\n\n");
ALIGNED(4) const u8 gCreditsString_Ken_Sugimori_Shigeki_Morimoto[] = _("\n\nKen Sugimori\n\nShigeki Morimoto\n\n");
ALIGNED(4) const u8 gCreditsString_Program_Leader_Planning_Leader_Graphic_Design_Leader[] = _("Líder de programación\n\nLíder de planificación\n\nLíder de diseño gráfico\n\n");
...
ALIGNED(4) const u8 gCreditsString_System_Programmers[] = _("Programadores de sistemas\n\n\n\n\n\n");
ALIGNED(4) const u8 gCreditsString_Tetsuya_Watanabe_Akito_Mori_Hisashi_Sogabe_Sousuke_Tamada[] = _("\nTetsuya Watanabe\nAkito Mori\nHisashi Sogabe\nSousuke Tamada\n\n");
ALIGNED(4) const u8 gCreditsString_Graphic_Designers[] = _("Diseñadores gráficos\n\n\n\n\n\n");
...
ALIGNED(4) const u8 gCreditsString_Information_Supervisors[] = _("Supervisión de información\n\n\n\n\n\n");
ALIGNED(4) const u8 gCreditsString_Hiroki_Enomoto_Kazuyuki_Terada_Yuri_Sakurai_Yumi_Funasaka_Naoko_Yanase[] = _("\nHiroki Enomoto\nKazuyuki Terada\nYuri Sakurai\nYumi Funasaka\nNaoko Yanase\n");
ALIGNED(4) const u8 gCreditsString_Coordinators[] = _("Coordinadores\n\n\n\n\n\n");
...
ALIGNED(4) const u8 gCreditsString_English_Version_Coordinators[] = _("Coordinadores de la versión\nen inglés\n\n\n\n\n");
...
ALIGNED(4) const u8 gCreditsString_Environment_Tool_Programmers[] = _("Programadores de herrammientas\ny entornos\n\n\n\n\n");
ALIGNED(4) const u8 gCreditsString_Teruki_Murakawa_Souichi_Yamamoto_Kimiko_Nakamichi[] = _("\n\n\nTeruki Murakawa\nSouichi Yamamoto\nKimiko Nakamichi\n");
ALIGNED(4) const u8 gCreditsString_NOA_Product_Testing[] = _("Pruebas del producto en NOA\n\n\n\n\n\n");
ALIGNED(4) const u8 gCreditsString_Thomas_Hertzog_Kathy_Huguenard_Mika_Kurosawa[] = _("\nThomas Hertzog\nKathy Huguenard\nMika Kurosawa\n\n\n");
ALIGNED(4) const u8 gCreditsString_Braille_Code_Check_2[] = _("Revisión de texto en braille\n\n\n\n\n\n");
...
ALIGNED(4) const u8 gCreditsString_Special_Thanks_4[] = _("Agradecimientos\n\n\n\n\n\n");
ALIGNED(4) const u8 gCreditsString_Takehiro_Izushi_Motoyasu_Tojima_Hitoshi_Yamagami_Hiroyuki_Uesugi[] = _("\nTakehiro Izushi\nMotoyasu Tojima\nHitoshi Yamagami\nHiroyuki Uesugi\n\n");
ALIGNED(4) const u8 gCreditsString_Special_Thanks_5[] = _("Agradecimientos\n\n\n\n\n\n");
...
const u8 gText_HelpSystemControls_PickOkEnd[] = _("{DPAD_UPDOWN}SEL. {A_BUTTON}BIEN {B_BUTTON}FIN");
const u8 gText_HelpSystemControls_AorBtoCancel[] = _("{A_BUTTON}{B_BUTTON}ATRÁS");
const u8 gText_HelpSystemControls_PickOkCancel[] = _("{DPAD_UPDOWN}SEL. {A_BUTTON}BIEN {B_BUTTON}ATRÁS");
...
const u8 gText_1_2_and_Poof[] = _("{PAUSE 0x20}1, {PAUSE 0x0F}2, y {PAUSE 0x0F}‥ {PAUSE 0x0F}‥ {PAUSE 0x0F}‥ {PAUSE 0x0F}{PLAY_SE SE_BALL_BOUNCE_1}¡Poof!\p");
const u8 gText_MonForgotOldMoveAndMonLearnedNewMove[] = _("{STR_VAR_1} olvidó {STR_VAR_3}.\pY‥\p{STR_VAR_1}\naprendió {STR_VAR_2}.");
...
const u8 gText_PickOKCancel[] = _("{DPAD_UPDOWN}SEL. {A_BUTTON}BIEN {B_BUTTON}SALIR");
