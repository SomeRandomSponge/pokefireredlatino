...
static const u8 sText_PreventsEscape[] = _("¡{B_SCR_ACTIVE_NAME_WITH_PREFIX} impide el\nescape con {B_SCR_ACTIVE_ABILITY}!\p");
...
static const u8 sText_HitXTimes[] = _("¡Hizo efecto {B_BUFF1} veces!");
...
static const u8 sText_PkmnHurtByPoison[] = _("¡El veneno hiere a {B_ATK_NAME_WITH_PREFIX}!");
static const u8 sText_PkmnAlreadyPoisoned[] = _("{B_DEF_NAME_WITH_PREFIX} ya está\nenvenenad{B_DEF_OA}.");
static const u8 sText_PkmnBadlyPoisoned[] = _("¡{B_EFF_NAME_WITH_PREFIX} fue gravemente\nenvenenad!");
...
static const u8 sText_PkmnHurtByBurn[] = _("¡{B_ATK_NAME_WITH_PREFIX} es herid{B_ATK_OA}\npor su quemadura!");
static const u8 sText_PkmnAlreadyHasBurn[] = _("{B_DEF_NAME_WITH_PREFIX} ya tiene\nuna quemadura.");
static const u8 sText_PkmnWasFrozen[] = _("¡{B_EFF_NAME_WITH_PREFIX} fue congelado\npor completo!");
...
static const u8 sText_PkmnWasDefrostedBy[] = _("¡{B_ATK_NAME_WITH_PREFIX} se\ndescongeló gracias a {B_CURRENT_MOVE}!");
static const u8 sText_PkmnWasParalyzed[] = _("¡{B_EFF_NAME_WITH_PREFIX} está paralizado!\n¡Tal vez no pueda moverse!");
static const u8 sText_PkmnWasParalyzedBy[] = _("¡{B_SCR_ACTIVE_ABILITY} de {B_SCR_ACTIVE_NAME_WITH_PREFIX}\nparalizó a {B_EFF_NAME_WITH_PREFIX}!\l¡Tal vez no pueda moverse!");
static const u8 sText_PkmnIsParalyzed[] = _("¡{B_ATK_NAME_WITH_PREFIX} está paralizad{B_ATK_OA}!\n¡No se puede mover!");
static const u8 sText_PkmnIsAlreadyParalyzed[] = _("¡{B_DEF_NAME_WITH_PREFIX} ya\nestá paralizad{B_DEF_OA}!");
static const u8 sText_PkmnHealedParalysis[] = _("¡{B_DEF_NAME_WITH_PREFIX} se\ncuró de su paralisis!");
static const u8 sText_PkmnDreamEaten[] = _("¡El sueño de {B_DEF_NAME_WITH_PREFIX}\nfue comido!");
...
static const u8 sText_PkmnHealedConfusion[] = _("¡{B_ATK_NAME_WITH_PREFIX} salió\nde la confusión!");
static const u8 sText_PkmnWasConfused[] = _("¡{B_EFF_NAME_WITH_PREFIX}\nse confundió!");
static const u8 sText_PkmnAlreadyConfused[] = _("¡{B_DEF_NAME_WITH_PREFIX} ya\nestá confundid{B_DEF_OA}!");
static const u8 sText_PkmnFellInLove[] = _("¡{B_DEF_NAME_WITH_PREFIX}\nse enamoró!");
static const u8 sText_PkmnInLove[] = _("¡{B_ATK_NAME_WITH_PREFIX} está enamorad{B_ATK_OA}\nde {B_SCR_ACTIVE_NAME_WITH_PREFIX}!");
static const u8 sText_PkmnImmobilizedByLove[] = _("¡El amor deja inmovil a\n{B_ATK_NAME_WITH_PREFIX}!");
static const u8 sText_PkmnBlownAway[] = _("¡{B_DEF_NAME_WITH_PREFIX} salió\nvolando!");
static const u8 sText_PkmnChangedType[] = _("¡{B_ATK_NAME_WITH_PREFIX} se transformó\nen el tipo {B_BUFF1}!");
static const u8 sText_PkmnFlinched[] = _("¡{B_ATK_NAME_WITH_PREFIX} se estremeció!");
...
static const u8 sText_PkmnRaisedSpDef[] = _("¡{B_CURRENT_MOVE} de {B_ATK_PREFIX2}\naumento su DEF. ESPECIAL!");
static const u8 sText_PkmnRaisedSpDefALittle[] = _("¡{B_CURRENT_MOVE} de {B_ATK_PREFIX2}\naumento un poco su DEF. ESPECIAL!");
static const u8 sText_PkmnRaisedDef[] = _("¡{B_CURRENT_MOVE} de {B_ATK_PREFIX2}\naumento su DEFENSA!");
static const u8 sText_PkmnRaisedDefALittle[] = _("¡{B_CURRENT_MOVE} de {B_ATK_PREFIX2}\naumento un poco su DEFENSA!");
static const u8 sText_PkmnCoveredByVeil[] = _("¡El equipo de {B_ATK_PREFIX2} está cubierto\npor un velo!");
static const u8 sText_PkmnUsedSafeguard[] = _("¡El equipo de {B_DEF_NAME_WITH_PREFIX} está protegido\npor SALVAGUARDA!");
static const u8 sText_PkmnSafeguardExpired[] = _("¡El equipo de {B_ATK_PREFIX3} ya no está\nprotegido por SALVAGUARDA!");
static const u8 sText_PkmnWentToSleep[] = _("¡{B_ATK_NAME_WITH_PREFIX} se fue\na dormir!");
static const u8 sText_PkmnSleptHealthy[] = _("¡{B_ATK_NAME_WITH_PREFIX} durmió\ny recuperó su salud!");
static const u8 sText_PkmnWhippedWhirlwind[] = _("¡{B_ATK_NAME_WITH_PREFIX} causó\nun remolino!");
...
static const u8 sText_PkmnHidUnderwater[] = _("¡{B_ATK_NAME_WITH_PREFIX} se escondió\nbajo el agua!");
static const u8 sText_PkmnSprangUp[] = _("¡{B_ATK_NAME_WITH_PREFIX} dio un gran salto!");
static const u8 sText_PkmnSqueezedByBind[] = _("¡{B_DEF_NAME_WITH_PREFIX} fue apretad{B_DEF_OA} por la\nATADURA de {B_ATK_NAME_WITH_PREFIX}!");
static const u8 sText_PkmnTrappedInVortex[] = _("¡{B_DEF_NAME_WITH_PREFIX} está atrapad{B_DEF_OA}\nen el vórtice!");
static const u8 sText_PkmnTrappedBySandTomb[] = _("¡{B_DEF_NAME_WITH_PREFIX} fue atrapad{B_DEF_OA}\nen una TUMBA DE ARENA!");
static const u8 sText_PkmnWrappedBy[] = _("¡{B_DEF_NAME_WITH_PREFIX} fue ENVUELTO\n{B_ATK_NAME_WITH_PREFIX}!");
static const u8 sText_PkmnClamped[] = _("¡{B_ATK_NAME_WITH_PREFIX} SUJETÓ a\n{B_DEF_NAME_WITH_PREFIX}!");
static const u8 sText_PkmnHurtBy[] = _("¡{B_ATK_NAME_WITH_PREFIX} fue herido\npor {B_BUFF1}!");
static const u8 sText_PkmnFreedFrom[] = _("¡{B_ATK_NAME_WITH_PREFIX} fue liberado\nde {B_BUFF1}!");
static const u8 sText_PkmnCrashed[] = _("¡{B_ATK_NAME_WITH_PREFIX} falló su ataque\ny se calló!");
const u8 gBattleText_MistShroud[] = _("¡{B_ATK_PREFIX2} se\ncubrió en NIEBLA!");
static const u8 sText_PkmnProtectedByMist[] = _("¡{B_SCR_ACTIVE_NAME_WITH_PREFIX} está protegido\npor la NIEBLA!");
const u8 gBattleText_GetPumped[] = _("¡{B_ATK_NAME_WITH_PREFIX} se prepara\npara atacar!");
...
static const u8 sText_PkmnBuffetedBySandstorm[] = _("¡{B_ATK_NAME_WITH_PREFIX} es dañad{B_ATK_OA} por\nla tormenta de arena!");
static const u8 sText_PkmnPeltedByHail[] = _("¡{B_ATK_NAME_WITH_PREFIX} es dañad{B_ATK_OA} por\nel GRANIZO!");
...
static const u8 sText_PkmnEvadedAttack[] = _("¡{B_DEF_NAME_WITH_PREFIX} evadió\nel ataque!");
static const u8 sText_PkmnSappedByLeechSeed[] = _("¡DRENADORAS roba la salud de\n{B_ATK_NAME_WITH_PREFIX}!");
...
static const u8 sText_PkmnUproarKeptAwake[] = _("¡Pero el ALBOROTO de\n{B_SCR_ACTIVE_NAME_WITH_PREFIX} lo mantuvo despierto!");
static const u8 sText_PkmnWokeUpInUproar[] = _("¡{B_ATK_NAME_WITH_PREFIX} despertó\nen el ALBOROTO!");
static const u8 sText_PkmnCausedUproar[] = _("¡{B_ATK_NAME_WITH_PREFIX} causó\nun ALBOROTO!");
...
static const u8 sText_PkmnCantSleepInUproar[] = _("¡Pero {B_DEF_NAME_WITH_PREFIX} no puede\ndormir en un ALBOROTO!");
static const u8 sText_PkmnStockpiled[] = _("¡{B_ATK_NAME_WITH_PREFIX} RESERVÓ\n{B_BUFF1}!");
static const u8 sText_PkmnCantStockpile[] = _("¡{B_ATK_NAME_WITH_PREFIX} ya no\npuede RESERVAR!");
static const u8 sText_PkmnCantSleepInUproar2[] = _("¡Pero {B_DEF_NAME_WITH_PREFIX} no puede\ndormir en un ALBOROTO!");
static const u8 sText_UproarKeptPkmnAwake[] = _("¡Pero el ALBOROTO mantuvo a\n{B_DEF_NAME_WITH_PREFIX} despierto!");
static const u8 sText_PkmnStayedAwakeUsing[] = _("¡{B_DEF_NAME_WITH_PREFIX} se mantuvo despierto\nusando {B_DEF_ABILITY}!");
static const u8 sText_PkmnStoringEnergy[] = _("¡{B_ATK_NAME_WITH_PREFIX} está guardando\nenergía!");
static const u8 sText_PkmnUnleashedEnergy[] = _("¡{B_ATK_NAME_WITH_PREFIX} liberó\nenergía!");
static const u8 sText_PkmnFatigueConfusion[] = _("¡{B_ATK_NAME_WITH_PREFIX} está confundid{B_ATK_OA}\ndebido a la fatiga!");
static const u8 sText_PkmnPickedUpItem[] = _("¡{B_PLAYER_NAME} recogió\n¥{B_BUFF1}!\p");
static const u8 sText_PkmnUnaffected[] = _("¡{B_DEF_NAME_WITH_PREFIX} no fue\nafectad{B_DEF_OA}!");
...
static const u8 sText_SubstituteDamaged[] = _("¡El SUSTITUTO recibió el daño\npor {B_DEF_NAME_WITH_PREFIX}!\p");
...
static const u8 sText_PkmnMoveDisabledNoMore[] = _("¡{B_ATK_NAME_WITH_PREFIX} dejo de\nestar anulado!");
static const u8 sText_PkmnGotEncore[] = _("¡{B_DEF_NAME_WITH_PREFIX} obtuvo\nun OTRA VEZ!");
static const u8 sText_PkmnEncoreEnded[] = _("¡El OTRA VEZ de {B_ATK_NAME_WITH_PREFIX}\nterminó!");
static const u8 sText_PkmnTookAim[] = _("¡{B_ATK_NAME_WITH_PREFIX} está\napuntando a {B_DEF_NAME_WITH_PREFIX}!");
static const u8 sText_PkmnSketchedMove[] = _("¡{B_ATK_NAME_WITH_PREFIX} creó un\nBOCETO de {B_BUFF1}!");
static const u8 sText_PkmnTryingToTakeFoe[] = _("¡{B_ATK_NAME_WITH_PREFIX} intenta\nllevarse a su enemigo consigo!");
static const u8 sText_PkmnTookFoe[] = _("¡{B_DEF_NAME_WITH_PREFIX} se llevó\na {B_ATK_NAME_WITH_PREFIX} consigo!");
static const u8 sText_PkmnReducedPP[] = _("¡Los {B_BUFF1} de {B_DEF_NAME_WITH_PREFIX}\nbajaron por {B_BUFF2}!");
...
static const u8 sText_PkmnFellIntoNightmare[] = _("¡{B_DEF_NAME_WITH_PREFIX} cayó en\nuna PESADILLA!");
static const u8 sText_PkmnLockedInNightmare[] = _("¡{B_ATK_NAME_WITH_PREFIX} está atrapad{B_ATK_OA}\nen una PESADILLA!");
static const u8 sText_PkmnLaidCurse[] = _("¡{B_ATK_NAME_WITH_PREFIX} corta sus propios PS\ny MALDICE a {B_DEF_NAME_WITH_PREFIX}!");
static const u8 sText_PkmnAfflictedByCurse[] = _("¡{B_ATK_NAME_WITH_PREFIX} es afectad{B_ATK_OA}\npor la MALDICIÓN!");
static const u8 sText_SpikesScattered[] = _("¡Se esparcieron PÚAS en el\nlado del oponente!");
static const u8 sText_PkmnHurtBySpikes[] = _("¡{B_SCR_ACTIVE_NAME_WITH_PREFIX} es herido\npor las PÚAS!");
static const u8 sText_PkmnIdentified[] = _("¡{B_ATK_NAME_WITH_PREFIX} identificó\na {B_DEF_NAME_WITH_PREFIX}!");
static const u8 sText_PkmnPerishCountFell[] = _("¡La cuenta MORTAL de {B_ATK_NAME_WITH_PREFIX}\ncayó a {B_BUFF1}!");
static const u8 sText_PkmnBracedItself[] = _("¡{B_ATK_NAME_WITH_PREFIX} se\nfortaleció!");
static const u8 sText_PkmnEnduredHit[] = _("¡{B_DEF_NAME_WITH_PREFIX} RESISTIÓ\nel golpe!");
static const u8 sText_MagnitudeStrength[] = _("¡MAGNITUD {B_BUFF1}!");
static const u8 sText_PkmnCutHPMaxedAttack[] = _("¡{B_ATK_NAME_WITH_PREFIX} corta sus propios PS\ny maximiza su ATAQUE!");
static const u8 sText_PkmnCopiedStatChanges[] = _("¡{B_ATK_NAME_WITH_PREFIX} copió los cambios\nde estadísticas de {B_DEF_NAME_WITH_PREFIX}!");
static const u8 sText_PkmnGotFree[] = _("¡{B_ATK_NAME_WITH_PREFIX} se liberó de\n{B_BUFF1} de {B_DEF_NAME_WITH_PREFIX}!");
static const u8 sText_PkmnShedLeechSeed[] = _("¡{B_ATK_NAME_WITH_PREFIX} se liberó\nde las DRENADORAS!");
static const u8 sText_PkmnBlewAwaySpikes[] = _("¡{B_ATK_NAME_WITH_PREFIX} removió\nlas PÚAS!");
static const u8 sText_PkmnFledFromBattle[] = _("¡{B_ATK_NAME_WITH_PREFIX} huyó de\nla batalla!");
static const u8 sText_PkmnForesawAttack[] = _("¡{B_ATK_NAME_WITH_PREFIX} predijo\nun ataque!");
static const u8 sText_PkmnTookAttack[] = _("¡{B_DEF_NAME_WITH_PREFIX} recibió\n{B_BUFF1}!");
static const u8 sText_PkmnChoseXAsDestiny[] = _("¡{B_ATK_NAME_WITH_PREFIX} eligió\n{B_CURRENT_MOVE} como su destino!");
static const u8 sText_PkmnAttack[] = _("¡Ataque de {B_BUFF1}!");
static const u8 sText_PkmnCenterAttention[] = _("¡{B_ATK_NAME_WITH_PREFIX} se volvió\nel centro de atención!");
static const u8 sText_PkmnChargingPower[] = _("¡{B_ATK_NAME_WITH_PREFIX} empezó\na cargar poder!");
static const u8 sText_NaturePowerTurnedInto[] = _("¡ADAPTACIÓN se transformó en\n{B_CURRENT_MOVE}!");
static const u8 sText_PkmnStatusNormal[] = _("¡El estado de {B_ATK_NAME_WITH_PREFIX}\nregresó a la normalidad!");
static const u8 sText_PkmnSubjectedToTorment[] = _("¡{B_DEF_NAME_WITH_PREFIX} fue sometid{B_DEF_OA}\na un TORMENTO!");
static const u8 sText_PkmnTighteningFocus[] = _("¡{B_ATK_NAME_WITH_PREFIX} se está\nconcentrando!");
static const u8 sText_PkmnFellForTaunt[] = _("¡{B_DEF_NAME_WITH_PREFIX} cayó en\nla MOFA!");
static const u8 sText_PkmnReadyToHelp[] = _("¡{B_ATK_NAME_WITH_PREFIX} está list{B_ATK_OA} para\nayudar {B_DEF_NAME_WITH_PREFIX}!");
...
static const u8 sText_PkmnPlantedRoots[] = _("¡{B_ATK_NAME_WITH_PREFIX} plantó sus raíces!");
...
static const u8 sText_PkmnWasMadeDrowsy[] = _("¡{B_ATK_NAME_WITH_PREFIX} dejó a\n{B_DEF_NAME_WITH_PREFIX} mareado!");
static const u8 sText_PkmnKnockedOff[] = _("¡{B_ATK_NAME_WITH_PREFIX} DESARMÓ a\n{B_DEF_NAME_WITH_PREFIX}, removiendo {B_LAST_ITEM}!");
static const u8 sText_PkmnSwappedAbilities[] = _("¡{B_ATK_NAME_WITH_PREFIX} intercambió habilidades\ncon su oponente!");
static const u8 sText_PkmnSealedOpponentMove[] = _("¡{B_ATK_NAME_WITH_PREFIX} selló\nel movimiento del oponenteシsス!");
static const u8 sText_PkmnWantsGrudge[] = _("¡{B_ATK_NAME_WITH_PREFIX} quiere que\nel oponente tenga RABIA!");
static const u8 sText_PkmnLostPPGrudge[] = _("¡{B_BUFF1} de {B_ATK_NAME_WITH_PREFIX} perdió\ntodos PP sus debido a la RABIA!");
static const u8 sText_PkmnShroudedItself[] = _("¡{B_ATK_NAME_WITH_PREFIX} se cubrió\nen {B_CURRENT_MOVE}!");
static const u8 sText_PkmnMoveBounced[] = _("¡{B_CURRENT_MOVE} de {B_ATK_NAME_WITH_PREFIX}\nrebotó gracias a la CAPA MÁGICA!");
static const u8 sText_PkmnWaitsForTarget[] = _("¡{B_ATK_NAME_WITH_PREFIX} espera a que su\noponente haga un movimiento!");
static const u8 sText_PkmnSnatchedMove[] = _("¡{B_DEF_NAME_WITH_PREFIX} ROBÓ\nel movimiento de {B_SCR_ACTIVE_NAME_WITH_PREFIX}!");
static const u8 sText_ElectricityWeakened[] = _("¡El poder de la electricidad\nfue reducido!");
static const u8 sText_FireWeakened[] = _("¡El poder del fuego\nfue reducido!");
...
static const u8 sText_ItemsCantBeUsedNow[] = _("No se pueden usar objetos ahora.{PAUSE 64}");
...
static const u8 sText_PkmnLostFocus[] = _("¡{B_ATK_NAME_WITH_PREFIX} perdió su\nconcentración y no se puede mover!");
static const u8 sText_PkmnWasDraggedOut[] = _("¡{B_DEF_NAME_WITH_PREFIX} fue\narrastrad{B_DEF_OA} a la batalla!\p");
static const u8 sText_TheWallShattered[] = _("¡La pantalla se quebró!");
static const u8 sText_ButNoEffect[] = _("¡Pero no tuvo efecto!");
static const u8 sText_PkmnHasNoMovesLeft[] = _("¡{B_ACTIVE_NAME_WITH_PREFIX} ya no\ntiene movimientos!\p");
static const u8 sText_PkmnMoveIsDisabled[] = _("¡{B_CURRENT_MOVE} de {B_ACTIVE_NAME_WITH_PREFIX}\nestá anulado!\p");
static const u8 sText_PkmnCantUseMoveTorment[] = _("¡{B_ACTIVE_NAME_WITH_PREFIX} no puede repetir\nel movimiento debido al TORMENTO!\p");
static const u8 sText_PkmnCantUseMoveTaunt[] = _("¡{B_ACTIVE_NAME_WITH_PREFIX} no puede usar\n{B_CURRENT_MOVE} despúes de la MOFA!\p");
static const u8 sText_PkmnCantUseMoveSealed[] = _("¡{B_ACTIVE_NAME_WITH_PREFIX} no puede usar\n{B_CURRENT_MOVE} sellado!\p");
...
static const u8 sText_PkmnProtectedBy[] = _("¡{B_DEF_NAME_WITH_PREFIX} fue protegid{B_DEF_OA}\npor {B_DEF_ABILITY}!");
...
static const u8 sText_CriticalHit[] = _("¡Es un ataque crítico!");
static const u8 sText_OneHitKO[] = _("¡Es un ataque fulminante!");
...
static const u8 sText_PlayerBattledToDrawLinkTrainer[] = _("¡Empataste en una batalla contra\n{B_LINK_OPPONENT1_NAME}!");
static const u8 sText_PlayerBattledToDrawVsTwo[] = _("¡Empataste en una batalla contra\n{B_LINK_OPPONENT1_NAME} y {B_LINK_OPPONENT2_NAME}!");
static const u8 sText_WildFled[] = _("{PLAY_SE SE_FLEE}¡{B_LINK_OPPONENT1_NAME} huyó!");
static const u8 sText_TwoWildFled[] = _("{PLAY_SE SE_FLEE}¡{B_LINK_OPPONENT1_NAME} y\n{B_LINK_OPPONENT2_NAME} huyeron!");
...
static const u8 sText_SandstormBrewed[] = _("¡Una tormenta de arena comenzó!");
static const u8 sText_SandstormRages[] = _("La tormenta de arena continua.");
static const u8 sText_SandstormSubsided[] = _("La tormenta de arena se detuvo.");
static const u8 sText_SunlightGotBright[] = _("¡La luz del sol se volvió\nmás fuerte!");
static const u8 sText_SunlightStrong[] = _("La luz del sol es intensa.");
static const u8 sText_SunlightFaded[] = _("La luz del sol volvió a\nla normalidad.");
static const u8 sText_StartedHail[] = _("¡Empezó a granizar!");
static const u8 sText_HailContinues[] = _("Sigue callendo granizo.");
static const u8 sText_HailStopped[] = _("El granizo se detuvo.");
static const u8 sText_FailedToSpitUp[] = _("¡Pero no pudo ESCUPIR nada!");
static const u8 sText_FailedToSwallow[] = _("¡Pero no pudo TRAGAR nada!");
static const u8 sText_WindBecameHeatWave[] = _("¡El viento se convirtió en\nuna ONDA DE CALOR!");
static const u8 sText_StatChangesGone[] = _("¡Todos los cambios de estadísticas\nfueron eliminados!");
static const u8 sText_CoinsScattered[] = _("¡Se esparcieron monedas por\ntodos lados!");
static const u8 sText_TooWeakForSubstitute[] = _("¡Está demasiado débil para\nhacer un SUSTITUTO!");
static const u8 sText_SharedPain[] = _("¡Los combatientes compartieron\nsu dolor!");
static const u8 sText_BellChimed[] = _("¡Se escucha una campanada!");
static const u8 sText_FaintInThree[] = _("¡Todos los POKéMON afectados\nse debilitarán en tres turnos!");
static const u8 sText_NoPPLeft[] = _("¡No quedan PP para este\nmovimiento!\p");
static const u8 sText_ButNoPPLeft[] = _("¡Pero no quedaban PP para\nel movimiento!");
static const u8 sText_PkmnIgnoresAsleep[] = _("¡{B_ATK_NAME_WITH_PREFIX} ignoró\nlas órdenes mientras duerme!");
static const u8 sText_PkmnIgnoredOrders[] = _("¡{B_ATK_NAME_WITH_PREFIX} ignoró\nlas órdenes!");
static const u8 sText_PkmnBeganToNap[] = _("¡{B_ATK_NAME_WITH_PREFIX} tomó una siesta!");
...
static const u8 sText_PkmnTurnedAway[] = _("¡{B_ATK_NAME_WITH_PREFIX} te da la espalda!");
...
static const u8 sText_ThrewARock[] = _("¡{B_PLAYER_NAME} lanzó una ROCA\nal {B_OPPONENT_MON1_NAME}!");
static const u8 sText_ThrewSomeBait[] = _("¡{B_PLAYER_NAME} lanzó algo de CEBO\nal {B_OPPONENT_MON1_NAME}!");
static const u8 sText_PkmnWatchingCarefully[] = _("¡{B_OPPONENT_MON1_NAME} está mirando\ncuidadosamente!");
static const u8 sText_PkmnIsAngry[] = _("¡{B_OPPONENT_MON1_NAME} está molesto!");
static const u8 sText_PkmnIsEating[] = _("¡{B_OPPONENT_MON1_NAME} está comiendo!");
static const u8 sText_OutOfSafariBalls[] = _("{PLAY_SE SE_DING_DONG}AVISO:¡Te quedaste sin\nBOLAS SAFARI! ¡fin del juego!\p");
...
static const u8 sText_GhostAppearedCantId[] = _("¡Apareció un FANTASMA!\p¡Rayos!\n¡No puedes identificarlo!\p");
static const u8 sText_TheGhostAppeared[] = _("¡Apareció un FANTASMA!\p");
...
static const u8 sText_Pkmna[] = _("a");
static const u8 sText_Pkmno[] = _("o");
...
static const u8 sText_PokeblockWasTooSpicy[] = _("fue demasiado picante!"); //
static const u8 sText_PokeblockWasTooDry[] = _("fue demasiado seca!");
static const u8 sText_PokeblockWasTooSweet[] = _("fue demasiado dulce!");
static const u8 sText_PokeblockWasTooBitter[] = _("fue demasiado amarga!");
static const u8 sText_PokeblockWasTooSour[] = _("fue demasiado ácida!");
...
static const u8 sText_PokedudeUsedItem[] = _("¡El POKé INSTRUCTOR usó\n{B_LAST_ITEM}!");
...
static const u8 sText_GotchaPkmnCaught[] = _("¡Listo!\n¡{B_OPPONENT_MON1_NAME} fue atrapado!{WAIT_SE}{PLAY_BGM MUS_CAUGHT}\p");
static const u8 sText_GotchaPkmnCaught2[] = _("¡Listo!\n¡{B_OPPONENT_MON1_NAME} fue atrapado!{WAIT_SE}{PLAY_BGM MUS_CAUGHT}{PAUSE 127}");
static const u8 sText_GiveNicknameCaptured[] = _("¿Le darás un apodo al\n{B_OPPONENT_MON1_NAME} atrapado?");
...
static const u8 sText_PlayedFluteCatchyTune[] = _("{B_PLAYER_NAME} tocó la {B_LAST_ITEM}.\p¡Es una tonada pegadiza!");
static const u8 sText_PlayedThe[] = _("{B_PLAYER_NAME} tocó\n{B_LAST_ITEM}.");
static const u8 sText_PkmnHearingFluteAwoke[] = _("¡El POKéMON despertó al escuchar\nla FLAUTA!");
...
const u8 gText_SafariZoneMenu[] = _("{PALETTE 5}{COLOR_HIGHLIGHT_SHADOW 13 14 15}BOLA{CLEAR_TO 56}CEBO\nROCA{CLEAR_TO 56}CORRER");
...
const u8 gText_BattleSwitchWhich[] = _("{PALETTE 5}{COLOR_HIGHLIGHT_SHADOW 13 14 15}¿Cambiar\npor quien?");
...
const u8 gText_SafariBalls[] = _("{HIGHLIGHT 2}BOLAS SAFARI"); //
...
const u8 gText_XMinYZSec[] = _("{STR_VAR_1}MIN. {STR_VAR_2}.{STR_VAR_3}SEG.");
...
u32 BattleStringExpandPlaceholders(const u8 *src, u8 *dst)
{
    ...
    u16 speciesAttacker;
    u16 speciesTarget;
    u32 personalityAttacker;
    u32 personalityTarget;
    s32 i;
    ...
    while (*src != EOS)
    {
        if (*src == PLACEHOLDER_BEGIN)
        {
            ...
            case B_TXT_SCR_ACTIVE_NAME_WITH_PREFIX: // scripting active battlerId name with prefix
                ...
                break;
            case B_TXT_ATK_OA: // attacker gender test
                if (GetBattlerSide(gBattlerAttacker) == B_SIDE_PLAYER)
                {
                ...
                if (GetGenderFromSpeciesAndPersonality(speciesAttacker, personalityAttacker) == MON_FEMALE)
                {
                    toCpy = sText_Pkmna;
                }
                else
                ...
                break;
            case B_TXT_DEF_OA: // target gender test
                ...
                if (GetGenderFromSpeciesAndPersonality(speciesTarget, personalityTarget) == MON_FEMALE)
                {
                    toCpy = sText_Pkmna;
                }
                else
