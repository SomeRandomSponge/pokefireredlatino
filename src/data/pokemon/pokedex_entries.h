const struct PokedexEntry gPokedexEntries[] =
{
    ...
    {
        .categoryName = _("TORTUGA PEQUEÑA"),
        .height = 5,
        .weight = 90,
    ...
    {
        .categoryName = _("POLILLA VENENOSA"),
        .height = 15,
        .weight = 125,
    ...
    [NATIONAL_DEX_PONYTA] =
    {
        .categoryName = _("CABALLO DE FUEGO"),
        .height = 10,
        .weight = 300,
    ...
    [NATIONAL_DEX_KRABBY] =
    {
        .categoryName = _("CANGREJO DE RÍO"),
        .height = 4,
        .weight = 65,
    ...
    [NATIONAL_DEX_STARYU] =
    {
        .categoryName = _("FORMA ESTRELLADA"),
        .height = 8,
        .weight = 345,
    ...
    [NATIONAL_DEX_ZAPDOS] =
    {
        .categoryName = _("CHOQUE ELÉCTRICO"),
        .height = 16,
        .weight = 526,
    ...
    {
        .categoryName = _("MANDÍBULA GRANDE"),
        .height = 6,
        .weight = 95,
    ...
    [NATIONAL_DEX_LEDYBA] =
    {
        .categoryName = _("CINCO ESTRELLAS"),
        .height = 10,
        .weight = 108,
    ...
    [NATIONAL_DEX_TOGEPI] =
    {
        .categoryName = _("BOLA DE ESPINAS"),
        .height = 3,
        .weight = 15,
    ...
    {
        .categoryName = _("SERPIENTE TIERRA"),
        .height = 15,
        .weight = 140,
    ...
    [NATIONAL_DEX_GLIGAR] =
    {
        .categoryName = _("ESCORPIÓN VOLADOR"),
        .height = 11,
        .weight = 648,
    ...
    {
        .categoryName = _("SERPIENTE ACERO"),
        .height = 92,
        .weight = 4000,
    ...
    {
        .categoryName = _("GECKO DE BOSQUE"),
        .height = 5,
        .weight = 50,
    ...
    {
        .categoryName = _("MAPACHE PEQUEÑO"),
        .height = 4,
        .weight = 175,
    ...
    {
        .categoryName = _("GOLONDRINA PEQUEÑA"),
        .height = 3,
        .weight = 23,
    ...
    {
        .categoryName = _("PATINADOR ACUÁTICO"),
        .height = 5,
        .weight = 17,
    ...
    {
        .categoryName = _("EMPUJE DE PALMA"),
        .height = 23,
        .weight = 2538,
    ...
    [NATIONAL_DEX_ARON] =
    {
        .categoryName = _("ARMADURA HIERRO"),
        .height = 4,
        .weight = 600,
    ...
    [NATIONAL_DEX_SWALOT] =
    {
        .categoryName = _("BOLSA DE VENENO"),
        .height = 17,
        .weight = 800,
    ...
    {
        .categoryName = _("BALLENA FLOTADORA"),
        .height = 145,
        .weight = 3980,
    ...
    [NATIONAL_DEX_SPINDA] =
    {
        .categoryName = _("PANDA CON PUNTOS"),
        .height = 11,
        .weight = 50,
    ...
    {
        .categoryName = _("SERPIENTE COLMILLO"),
        .height = 27,
        .weight = 525,
    ...
    [NATIONAL_DEX_BALTOY] =
    {
        .categoryName = _("FIGURA DE ARCILLA"),
        .height = 5,
        .weight = 215,
    ...
    {
        .categoryName = _("CAMARÓN ANTIGUO"),
        .height = 7,
        .weight = 125,
    ...
    {
        .categoryName = _("SONIDO DEL VIENTO"),
        .height = 6,
        .weight = 10,
    ...
    {
        .categoryName = _("PARAGUAS NEVADO"),
        .height = 7,
        .weight = 168,
    ...
    [NATIONAL_DEX_METANG] =
    {
        .categoryName = _("GARRA DE HIERRO"),
        .height = 12,
        .weight = 2025,
    ...
    {
        .categoryName = _("PIERNA DE HIERRO"),
        .height = 16,
        .weight = 5500,
