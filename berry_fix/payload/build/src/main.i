...
void AgbMain(void)
{
    ...
    { vu32 *dmaRegs = (vu32 *)(0x4000000 + 0xd4); dmaRegs[0] = (vu32)(intr_main); dmaRegs[1] = (vu32)(gIntrVector); dmaRegs[2] = (vu32)((0x8000 | 0x0000 | 0x0400 | 0x0000 | 0x0000) << 16 | ((sizeof(gIntrVector))/(32/8))); dmaRegs[2]; };
